      ...
      <form @submit.prevent="register" class="card card-form">
        ...
        <div class="form-group">
          ...
          <template v-if="$v.form.email.$error">
            ...
            <span v-else-if="!$v.form.email.unique" class="form-error">Sorry! This email is already taken</span>
          </template>
        </div>
        ...
        <div class="form-group">
          ...
          <input
            ...
            <template v-if="$v.form.avatar.$error">
              ...
              <span v-else-if="!$v.form.avatar.responseOk" class="form-error">The image cannot be found</span>
          </template>
        </div>
