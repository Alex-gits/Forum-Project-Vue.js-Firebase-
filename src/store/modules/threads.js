...
export default {
  ...
  actions: {
      ...
      return new Promise((resolve, reject) => {
        ...
        firebase.database().ref().update(updates)
          .then(() => {
            ...
            commit('appendContributorToThread', { parentId: post.threadId, childId: userId })
    ...
    fetchThread: ({ dispatch }, { id }) => dispatch('fetchItem', { resource: 'threads', id, source: 'fetchThread' }, { root: true }),

    fetchThreads: ({ dispatch }, { ids }) => dispatch('fetchItems', { resource: 'threads', source: 'FetchThreads', ids }, { root: true })
  },
